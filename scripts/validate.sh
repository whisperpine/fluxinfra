...
echo "INFO - # -------- Making sure yaml files are syntactically correct -------- #"
...
echo "INFO - # -------- Validating ./base -------- #"
find ./base -maxdepth 2 -type f -name '*.yaml' -print0 | while IFS= read -r -d $'\0' file; do
